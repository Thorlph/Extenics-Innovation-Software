...
this.drawMain(time_canvas, 70, "#000000", "#eef7e4");  
...
{  
    ...
    */  
    ...
    function text(n){  
        ...
        context.fillText(n.toFixed(0)+"%", center_x-text_width/2, center_y + font_size/2-30);  
        context.fillText("贡献度", center_x-text_width/2-25, center_y + font_size/2+50); 
        context.restore();  
    }  
